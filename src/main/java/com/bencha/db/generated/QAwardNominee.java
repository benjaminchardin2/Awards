...
public class QAwardNominee extends com.querydsl.sql.RelationalPathBase<AwardNominee> {
    ...
    public final StringPath nameOverride = createString("nameOverride");
    ...
    public final com.querydsl.sql.ForeignKey<Pronostic> _awdPronosticAwdAwardNomineeIdFk = createInvForeignKey(id, "nominee_id");
    ...
    public void addMetadata() {
        ...
        addMetadata(nameOverride, ColumnMetadata.named("name_override").withIndex(5).ofType(Types.LONGVARCHAR).withSize(65535));
